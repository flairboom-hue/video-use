...
- **Cuts out filler words** (`umm`, `uh`, false starts) and dead space between takes — optionally seeded by [auto-editor](https://github.com/WyattBlue/auto-editor) silence detection
